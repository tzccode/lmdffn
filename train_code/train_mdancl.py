...
parser.add_argument("--method_name", type=str, default="MDANCL", help="method/model name")
...
generator = MDANCL(scale=opt.upscale_factor, rgb_range=opt.rgb_range).to(device)
