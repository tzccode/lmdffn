...
parser.add_argument("--method_name", type=str, default="MDANCNR", help="method/model name")
...
generator = MDANCNR(scale=opt.upscale_factor, rgb_range=opt.rgb_range).to(device)
