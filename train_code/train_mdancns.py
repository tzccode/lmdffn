...
parser.add_argument("--method_name", type=str, default="MDANCNS", help="method/model name")
...
generator = MDANCNS(scale=opt.upscale_factor, rgb_range=opt.rgb_range).to(device)
