...
parser.add_argument("--method_name", type=str, default="MDANC", help="method/model name")
...
generator = MDANC(scale=opt.upscale_factor, rgb_range=opt.rgb_range).to(device)
