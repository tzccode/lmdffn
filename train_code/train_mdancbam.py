...
parser.add_argument("--method_name", type=str, default="MDANCBAM", help="method/model name")
...
generator = MDANCBAM(scale=opt.upscale_factor, rgb_range=opt.rgb_range).to(device)
